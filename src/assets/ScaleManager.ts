...
class ScaleManager {
  ...
  private static guidelineBaseWidth = 375;

  private static guidelineBaseHeight = 812;
  ...
  public static PADDING_SIZE = ScaleManager.scaleSizeWidth(24);

  public static WIDTH_SCREEN_MINUS_PADDING = ScaleManager.WINDOW_WIDTH - ScaleManager.PADDING_SIZE * 2;
