...
import { ISliderComponentProps } from "./Model.VerticalSliderComponent";
import styles from "./Styles.VerticalSliderComponent";
...
const SliderComponent = React.memo(
  ({
    ...
    const _moveStartValue = React.useRef(0);
    ...
    const [panResponder, setPanResponder] = React.useState<PanResponderInstance | undefined>(undefined);
    ...
    const fetchNewValueFromGesture = (gestureState: PanResponderGestureState): number => {
