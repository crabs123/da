...
import { IItemProps } from "./Model.WheelPickerComponent";
import styles from "./Styles.WheelPickerComponent";

const WheelPickerItem: React.FC<IItemProps> = ({
  textStyle,
  style,
  height,
  option,
  ...
  return (
    <Animated.View style={[styles.option, style, { height, opacity, transform: [{ translateY }, { rotateX }] }]}>
