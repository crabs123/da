...
const DoubleTapComponent = React.memo(({ children, onPress }: { children: ReactNode; onPress: Function }) => {
  const doubleTapRef = React.useRef(null);

  const onDoubleTapEvent = (event: HandlerStateChangeEvent<TapGestureHandlerEventPayload>) => {
